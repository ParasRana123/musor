...
export const StaggeredMenu = ({
  ...
  return (
    <div
      className={`sm-scope z-40 justify-center ${
        isFixed
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <img
              ...
              alt="Logo"
              className="m-logo-img block h-12 w-auto object-contain"
              draggable={false}
              width={140}
              height={60}
            />
            {/* {open ? (
              <div className="text-black ml-auto cursor-pointer" onClick={toggleMenu}>
                <FaCross />
              </div>
            ) : null} */}
          </div>
          ...
          >
            ...
            >
              ...
              >
                {textLines.map((l, i) => (
                  <span
                    className={`sm-toggle-line block h-[1em] leading-none z-10`}
                    key={i}
                  >
                    {l}
                  </span>
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 min-h-screen bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]"
